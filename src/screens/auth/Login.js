...
import { View, Text, StyleSheet, Image, TouchableOpacity, SafeAreaView, StatusBar, ActivityIndicator, Dimensions } from 'react-native';
...
export default function LoginScreen() {
    ...
    const [request, response, promptAsync] = useIdTokenAuthRequest({
        clientId: '44086127203-slure7mgqba0mlncip5lbfi0r5j4hj96.apps.googleusercontent.com',
    });
